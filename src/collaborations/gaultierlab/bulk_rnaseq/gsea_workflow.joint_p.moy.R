...
out_dir <- "~/Documents/projects/gaultierlab/stephanie_moy/bulkRNASeq/results/rnaseq.joint_p.fgsea/"
...
results_file <- "~/Documents/projects/gaultierlab/stephanie_moy/bulkRNASeq/results/joint_p_analysis/joint_p_deg_results.RDS"
...
# prep the results
results_list$joint_deg$stat <- results_list$joint_deg$joint_p *
  sign(results_list$joint_deg$log2FoldChange.opc)
results_list$joint_deg <- results_list$joint_deg[results_list$joint_deg$same_dir == T,]

results_list$opc_unique$stat <- results_list$opc_unique$opc_not_olt3 *
  sign(results_list$opc_unique$log2FoldChange.opc)

results_list$olt3_unique$stat <- results_list$olt3_unique$olt3_not_opc *
  sign(results_list$olt3_unique$log2FoldChange.olt3)
