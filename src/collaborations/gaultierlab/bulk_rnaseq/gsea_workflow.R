...
out_dir <- "~/Documents/projects/gaultierlab/sam_wachamo/bulkRNASeq/results/gsea_workflow/"
...
results_file <- "~/Documents/projects/gaultierlab/sam_wachamo/bulkRNASeq/results/deg_workflow/IAA_v_Vehicle.degs.RDS"
...
write.xlsx(total_gsea_results, 
           paste0(out_dir, "IAA_v_Vehicle.gsea_pathway_results.xlsx"), colWidths="auto")
