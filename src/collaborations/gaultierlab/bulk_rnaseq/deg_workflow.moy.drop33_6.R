...
out_dir <- "~/Documents/projects/gaultierlab/stephanie_moy/bulkRNASeq/results/deg_workflow.drop33_6/"
...
# drop sample 33 and sample 6
metadata <- metadata[!metadata$experiment.25027 %in% c(33,6),]
...
lapply(results_list, function(x){nrow(x[x$padj < 0.05,])})
