...
ggsave(paste0(out_dir, "total_integrated_cell_umap.per_sample.png"), width=10, height=8)
...
ggplot(metadata,
  ...
  facet_wrap(~ harmony_clusters, ncol=5, scale="free_y") +
  theme_bw() +
  theme(axis.text.x = element_text(angle=35, hjust=1)) +
  labs(x=NULL, y="Cell Count")
ggsave(paste0(out_dir, "sample_per_cluster_cell_count.png"), width=10, height=8)


# might want to experiment with different resolutions ...
