...
root_dir <- "~/Documents/projects/harrislab/Harris-AM-6617/"
...
h5_files <- list("6617-1"=paste0(root_dir, "cellranger_outputs/6617-1/filtered_feature_bc_matrix.h5"),
                 "6617-2"=paste0(root_dir, "cellranger_outputs/6617-2/filtered_feature_bc_matrix.h5"),
                 "6617-3"=paste0(root_dir, "cellranger_outputs/6617-3/filtered_feature_bc_matrix.h5"),
                 "6617-4"=paste0(root_dir, "cellranger_outputs/6617-4/filtered_feature_bc_matrix.h5"))
