...
out_dir <- paste0(root_dir, "results/cassia_endothelial_subclustering_results_analysis/")
dir.create(out_dir, showWarnings = F, recursive = T)


# read in CASSIA results
gemini_results <- read.csv(paste0(root_dir, "results/cassia_endothelial_subclustering/results_gemini_lc_summary.csv"))
claude_results <- read.csv(paste0(root_dir, "results/cassia_endothelial_subclustering/results_claude_sonnet_summary.csv"))
...
html_reports <- list.files(paste0(root_dir, "results/cassia_endothelial_subclustering/"),
