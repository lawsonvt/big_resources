...
out_dir <- paste0(root_dir, "results/salmon_deg_analysis.drop_20rr/")
...
top_gene_list <- results_list$`CAR_FUS-Control`$gene_id[1:9]
...
top_gene_list <- results_list$`CAR-Control`$gene_id[1:3]
