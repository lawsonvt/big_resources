...
out_dir <- "~/Documents/projects/sheybanilab/stef_maslova/results/gsea_workflow.salmon.direct_comparison/"
...
results_file <- "~/Documents/projects/sheybanilab/stef_maslova/results/salmon_deg_analysis.direct_comparison/deg_results.RDS"
