...
out_dir <- "~/Documents/projects/sheybanilab/stef_maslova/results/gsea_workflow.hisat2/"
...
results_file <- "~/Documents/projects/sheybanilab/stef_maslova/results/hisat2_deg_analysis/deg_results.RDS"
