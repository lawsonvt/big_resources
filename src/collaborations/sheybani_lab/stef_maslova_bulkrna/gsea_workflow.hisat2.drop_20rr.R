...
out_dir <- "~/Documents/projects/sheybanilab/stef_maslova/results/gsea_workflow.hisat2.drop_20rr/"
...
results_file <- "~/Documents/projects/sheybanilab/stef_maslova/results/hisat2_deg_analysis.drop_20rr/deg_results.RDS"
