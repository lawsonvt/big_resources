...
h5_files <- list("220221RK1"=paste0(root_dir, "Cellranger_output/220221RK1/filtered_feature_bc_matrix.h5"),
                 "220401RK1"=paste0(root_dir, "Cellranger_output/220401RK1/filtered_feature_bc_matrix.h5"),
                 "221118MP1"=paste0(root_dir, "Cellranger_output/221118MP1/filtered_feature_bc_matrix.h5"),
                 "230110xx1"=paste0(root_dir, "Cellranger_output/230110xx1/filtered_feature_bc_matrix.h5"),
                 "2209006MP1"=paste0(root_dir, "Cellranger_output/2209006MP1/filtered_feature_bc_matrix.h5"),
                 "20221214SM1"=paste0(root_dir, "Cellranger_output/20221214SM1/filtered_feature_bc_matrix.h5"))
