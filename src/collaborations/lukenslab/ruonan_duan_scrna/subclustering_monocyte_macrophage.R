...
out_dir <- paste0(root_dir, "results/subclustering_monocyte_macrophage/")
...
saveRDS(subset_subset_seu@meta.data, paste0(out_dir, "subset_monocyte_macrophage.metadata.RDS"))
