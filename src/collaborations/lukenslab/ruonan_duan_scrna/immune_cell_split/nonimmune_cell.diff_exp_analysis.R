...
out_dir <- paste0(root_dir, "results/immune_cell_split/nonimmune_cell.diff_exp_analysis/")
...
ggsave(paste0(out_dir, "cell_types.volcanoes.png"), width=7, height=5, bg="white")
