...
out_dir <- paste0(root_dir, "results/immune_cell_split/cassia_annotate_opc/")
dir.create(out_dir, showWarnings = F)

# load in markers
all_markers <- readRDS(paste0(root_dir, "results/immune_cell_split/subclustering_opc.round2/all_markers.opc.RDS"))
