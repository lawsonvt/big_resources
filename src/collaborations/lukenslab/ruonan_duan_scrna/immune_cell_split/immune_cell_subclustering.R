...
out_dir <- paste0(root_dir, "results/immune_cell_split/immune_cell_subclustering/")
...
subset_clusters <- "0,1,2,3,4,5,6,8,11,12,13,14,16,18,20,21,23,26,28,31,32,33,37"
...
# create umap
subset_seu <- RunUMAP(subset_seu, dims = 1:max_pc_dim, reduction="pca", reduction.name="umap.immune_pca")
...
ggsave(paste0(out_dir, "immune_subcluster.per_sample.umap.png"), width=14, height=7)
