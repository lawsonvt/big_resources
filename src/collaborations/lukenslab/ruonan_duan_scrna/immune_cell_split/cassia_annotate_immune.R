...
out_dir <- paste0(root_dir, "results/immune_cell_split/cassia_annotate_immune/")
dir.create(out_dir, showWarnings = F)

# load in markers
all_markers <- readRDS(paste0(root_dir, "results/immune_cell_split/find_all_markers.immune_cells/all_markers.RDS"))
