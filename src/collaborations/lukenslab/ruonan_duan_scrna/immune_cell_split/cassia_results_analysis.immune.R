...
out_dir <- paste0(root_dir, "results/immune_cell_split/cassia_results_analysis.immune/")
dir.create(out_dir, showWarnings = F)

# read in annotations Ruonan made
cell_annot <- read.xlsx(paste0(root_dir, "20260825 Immune cluster naming by Ruonan.xlsx"))
cell_annot$Notes <- NULL


# read in CASSIA results
gemini_results <- read.csv(paste0(root_dir, "results/immune_cell_split/cassia_annotate_immune/results_gemini_lc_summary.csv"))
claude_results <- read.csv(paste0(root_dir, "results/immune_cell_split/cassia_annotate_immune/results_claude_sonnet_summary.csv"))
...
html_reports <- list.files(paste0(root_dir, "results/immune_cell_split/cassia_annotate_immune/"),
