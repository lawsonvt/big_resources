...
# read in fasta file
fasta_file <- "~/Documents/projects/coutinholab/flyseq/Drosophila_melanogaster.BDGP6.54.cdna.all.fa.gz"
...
# save results
write.csv(metadata,
          "~/Documents/projects/coutinholab/flyseq/Drosophila_melanogaster.BDGP6.54.transcript2gene.csv",
          row.names = F)